...
`)+e+": "+t+B(" = ",n)+B(" ",P(r," "))},SelectionSet:{leave:({selections:e})=>Pt(e)},Field:{leave({alias:e,name:t,arguments:n,directives:r,selectionSet:o}){let i=B("",e,": ")+t,s=i+B("(",P(n,", "),")");return s.length>W0&&(s=i+B(`(
`,kc(P(n,`
`)),`
