...
`));return e.line+=l.length-1,e.lineStart=o,d}if(u===92&&n.charCodeAt(i+1)===34&&n.charCodeAt(i+2)===34&&n.charCodeAt(i+3)===34){c+=n.slice(a,i),a=i+1,i+=4;continue}if(u===10||u===13){c+=n.slice(a,i),l.push(c),u===13&&n.charCodeAt(i+1)===10?i+=2:++i,c="",a=i,o=i;continue}if(Mo(u))++i;else if(Mc(n,i))i+=2;else throw Ee(e.source,i,`Invalid character within String: ${Er(e,i)}.`)}throw Ee(e.source,i,"Unterminated string.")}function A0(e,t){let n=e.source.body,r=n.length,o=t+1;for(;o<r;){let i=n.charCodeAt(o);if(iv(i))++o;else break}return Ie(e,b.NAME,t,o,n.slice(t,o))}function _o(e){return _c(e,[])}function _c(e,t){switch(typeof e){case"string":return JSON.stringify(e);case"function":return e.name?`[function ${e.name}]`:"[function]";case"object":return O0(e,t);default:return String(e)}}function O0(e,t){if(e===null)return"null";if(t.includes(e))return"[Circular]";let n=[...t,e];if(F0(e)){let r=e.toJSON();if(r!==e)return typeof r=="string"?r:_c(r,n)}else if(Array.isArray(e))return H0(e,n);return L0(e,n)}function F0(e){return typeof e.toJSON=="function"}function L0(e,t){let n=Object.entries(e);return n.length===0?"{}":t.length>2?"["+U0(e)+"]":"{ "+n.map(([o,i])=>o+": "+_c(i,t)).join(", ")+" }"}function H0(e,t){if(e.length===0)return"[]";if(t.length>2)return"[Array]";let n=Math.min(10,e.length),r=e.length-n,o=[];for(let i=0;i<n;++i)o.push(_c(e[i],t));return r===1?o.push("... 1 more item"):r>1&&o.push(`... ${r} more items`),"["+o.join(", ")+"]"}function U0(e){let t=Object.prototype.toString.call(e).replace(/^\[object /,"").replace(/]$/,"");if(t==="Object"&&typeof e.constructor=="function"){let n=e.constructor.name;if(typeof n=="string"&&n!=="")return n}return t}var j0=globalThis.process&&!0,fv=j0?function(t,n){return t instanceof n}:function(t,n){if(t instanceof n)return!0;if(typeof t=="object"&&t!==null){var r;let o=n.prototype[Symbol.toStringTag],i=Symbol.toStringTag in t?t[Symbol.toStringTag]:(r=t.constructor)===null||r===void 0?void 0:r.name;if(o===i){let a=_o(t);throw new Error(`Cannot use ${o} "${a}" from another module or realm.
