...
`));return e.line+=l.length-1,e.lineStart=o,d}if(u===92&&n.charCodeAt(i+1)===34&&n.charCodeAt(i+2)===34&&n.charCodeAt(i+3)===34){c+=n.slice(s,i),s=i+1,i+=4;continue}if(u===10||u===13){c+=n.slice(s,i),l.push(c),u===13&&n.charCodeAt(i+1)===10?i+=2:++i,c="",s=i,o=i;continue}if(Ro(u))++i;else if(Rc(n,i))i+=2;else throw Ee(e.source,i,`Invalid character within String: ${Sr(e,i)}.`)}throw Ee(e.source,i,"Unterminated string.")}function O0(e,t){let n=e.source.body,r=n.length,o=t+1;for(;o<r;){let i=n.charCodeAt(o);if(iv(i))++o;else break}return Re(e,b.NAME,t,o,n.slice(t,o))}function Po(e){return Pc(e,[])}function Pc(e,t){switch(typeof e){case"string":return JSON.stringify(e);case"function":return e.name?`[function ${e.name}]`:"[function]";case"object":return F0(e,t);default:return String(e)}}function F0(e,t){if(e===null)return"null";if(t.includes(e))return"[Circular]";let n=[...t,e];if(L0(e)){let r=e.toJSON();if(r!==e)return typeof r=="string"?r:Pc(r,n)}else if(Array.isArray(e))return U0(e,n);return H0(e,n)}function L0(e){return typeof e.toJSON=="function"}function H0(e,t){let n=Object.entries(e);return n.length===0?"{}":t.length>2?"["+j0(e)+"]":"{ "+n.map(([o,i])=>o+": "+Pc(i,t)).join(", ")+" }"}function U0(e,t){if(e.length===0)return"[]";if(t.length>2)return"[Array]";let n=Math.min(10,e.length),r=e.length-n,o=[];for(let i=0;i<n;++i)o.push(Pc(e[i],t));return r===1?o.push("... 1 more item"):r>1&&o.push(`... ${r} more items`),"["+o.join(", ")+"]"}function j0(e){let t=Object.prototype.toString.call(e).replace(/^\[object /,"").replace(/]$/,"");if(t==="Object"&&typeof e.constructor=="function"){let n=e.constructor.name;if(typeof n=="string"&&n!=="")return n}return t}var B0=globalThis.process&&!0,fv=B0?function(t,n){return t instanceof n}:function(t,n){if(t instanceof n)return!0;if(typeof t=="object"&&t!==null){var r;let o=n.prototype[Symbol.toStringTag],i=Symbol.toStringTag in t?t[Symbol.toStringTag]:(r=t.constructor)===null||r===void 0?void 0:r.name;if(o===i){let s=Po(t);throw new Error(`Cannot use ${o} "${s}" from another module or realm.
