...
`)+e+": "+t+B(" = ",n)+B(" ",P(r," "))},SelectionSet:{leave:({selections:e})=>Pt(e)},Field:{leave({alias:e,name:t,arguments:n,directives:r,selectionSet:o}){let i=B("",e,": ")+t,a=i+B("(",P(n,", "),")");return a.length>H0&&(a=i+B(`(
`,Mc(P(n,`
`)),`
