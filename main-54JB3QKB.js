...
`));return e.line+=l.length-1,e.lineStart=o,d}if(u===92&&n.charCodeAt(i+1)===34&&n.charCodeAt(i+2)===34&&n.charCodeAt(i+3)===34){c+=n.slice(a,i),a=i+1,i+=4;continue}if(u===10||u===13){c+=n.slice(a,i),l.push(c),u===13&&n.charCodeAt(i+1)===10?i+=2:++i,c="",a=i,o=i;continue}if(Ro(u))++i;else if(Pc(n,i))i+=2;else throw Ee(e.source,i,`Invalid character within String: ${Sr(e,i)}.`)}throw Ee(e.source,i,"Unterminated string.")}function _0(e,t){let n=e.source.body,r=n.length,o=t+1;for(;o<r;){let i=n.charCodeAt(o);if(rv(i))++o;else break}return Ie(e,b.NAME,t,o,n.slice(t,o))}function Po(e){return Mc(e,[])}function Mc(e,t){switch(typeof e){case"string":return JSON.stringify(e);case"function":return e.name?`[function ${e.name}]`:"[function]";case"object":return k0(e,t);default:return String(e)}}function k0(e,t){if(e===null)return"null";if(t.includes(e))return"[Circular]";let n=[...t,e];if(N0(e)){let r=e.toJSON();if(r!==e)return typeof r=="string"?r:Mc(r,n)}else if(Array.isArray(e))return A0(e,n);return x0(e,n)}function N0(e){return typeof e.toJSON=="function"}function x0(e,t){let n=Object.entries(e);return n.length===0?"{}":t.length>2?"["+O0(e)+"]":"{ "+n.map(([o,i])=>o+": "+Mc(i,t)).join(", ")+" }"}function A0(e,t){if(e.length===0)return"[]";if(t.length>2)return"[Array]";let n=Math.min(10,e.length),r=e.length-n,o=[];for(let i=0;i<n;++i)o.push(Mc(e[i],t));return r===1?o.push("... 1 more item"):r>1&&o.push(`... ${r} more items`),"["+o.join(", ")+"]"}function O0(e){let t=Object.prototype.toString.call(e).replace(/^\[object /,"").replace(/]$/,"");if(t==="Object"&&typeof e.constructor=="function"){let n=e.constructor.name;if(typeof n=="string"&&n!=="")return n}return t}var F0=globalThis.process&&!0,uv=F0?function(t,n){return t instanceof n}:function(t,n){if(t instanceof n)return!0;if(typeof t=="object"&&t!==null){var r;let o=n.prototype[Symbol.toStringTag],i=Symbol.toStringTag in t?t[Symbol.toStringTag]:(r=t.constructor)===null||r===void 0?void 0:r.name;if(o===i){let a=Po(t);throw new Error(`Cannot use ${o} "${a}" from another module or realm.
